...
void main() {
  ...
  ko.addAll({
    ...
    'ui.home.bonds': '유대 {lumi} · {bora} · {taro} · {state}',
    'ui.home.goal.free': '이번 회차는 자유롭게 시작합니다.',
    'ui.home.goal.complete': '계절 목표를 모두 확인했습니다.',
    'ui.home.goal.next': '다음 목표 · {title} · {stat} {value}/{min}',
    'ui.home.talent': '재능 +{bonus}',
    'ui.home.forecast': '예상 · {effects}',
    'ui.home.forecast.none': '변화 없음',
    'ui.home.fatigueDelta': '피로 {delta}',
    'ui.home.risk.penalty': '피로 경고 · 성장 -{loss} · 휴식 {days}일',
    'ui.home.risk.strained': '높은 피로 · 휴식 {days}일',
    'ui.home.risk.recovery': '회복 선택 · 피로 {delta} · {days}일',
    'ui.home.risk.steady': '안정적인 속도',
    'ui.home.save': '저장/복원',
    'ui.home.illustration': '일러스트',
    'ui.home.spend': '하루 보내기 →',
    'ui.home.chapter': '{chapter}막 · 루멘의 {week}주차/{total} · {persona}',
    'ui.home.route': '발견 경로',
    'ui.home.ledger': '운명 도감',
    'ui.home.journal': '활동 회고',
    'ui.home.characters': '캐릭터 도감',
    'ui.home.environments': '환경 아틀라스',
    'ui.environment.summary': '6곳 · 사건·보상·기억이 이어지는 장소',
    'ui.home.bondsButton': '동행 기록',
    'ui.home.condition.clear': '마음이 맑아요',
    'ui.home.condition.tired': '조금 지쳤어요',
    'ui.home.condition.strained': '오늘은 무리하지 말기',
    'ui.event.small': '작은 사건 · {week}주차',
    'ui.event.choice': '선택 {index}',
    'ui.event.condition': '조건: {value} 필요',
    'ui.event.statDelta': '{stat} {delta}',
    'ui.event.coinDelta': '은화 {delta}',
    'ui.event.bondDelta': '유대 {name} {delta}',
    'ui.event.rivalDelta': '관계 {name} {delta}',
    'ui.event.statNeeded': '{stat} {min}',
    'ui.event.bondNeeded': '유대 {name} {min}',
    'ui.event.condition.none': '조건 없음',
    'ui.event.locked': '잠김',
    'ui.home.weeklyRecord': '이번 주 기록',
    'ui.home.prompt': '일정을 고르고 하루를 보냅니다.',
    'ui.home.result': '기록이 갱신되었습니다.',
    ...
    'ui.journal.subtitle': '오늘의 선택은 사라지지 않고 다음 시선이 됩니다.',
    'ui.journal.count': '발견 {found}/{total}',
    'ui.journal.hiddenTitle': '아직 쓰이지 않은 페이지',
    'ui.journal.hidden': '계속 걸으면 이 페이지가 열립니다.',
    'ui.journal.lock': '다음 하루가 이곳에 한 줄을 남깁니다.',
    'ui.journal.back': '← 홈으로',
    'ui.save.title': '기록 보관소',
    'ui.save.subtitle': '현재 상태를 안전한 코드로 보관하고 다른 실행에서 복원합니다.',
    'ui.save.replay': '기록 {count}회 · 목표 {done}/{total}',
    'ui.save.bonds': '동행 유대 · 루미 {lumi} · 보라 {bora} · 타로 {taro}',
    'ui.save.recent': '최근 기록',
    'ui.save.codeHint': '원본 저장 코드는 복사 버튼으로만 다룹니다.',
    'ui.save.endings': '엔딩 도감 {done}/{total}',
    'ui.save.noEndings': '아직 발견한 결말이 없습니다.',
    'ui.save.routes': '관계 도감 {done}/{total}',
    'ui.save.noRoutes': '아직 발견한 동행이 없습니다.',
    'ui.save.copy': '저장 코드 복사',
    'ui.save.restore': '저장 코드 복원',
    'ui.save.back': '← 홈으로',
    'ui.save.activity': '활동 · {stat} {delta}',
    'ui.save.event': '사건 · {label}',
    'ui.save.sideScene': '사이드 장면 · {title}',
    'ui.save.relationship': '관계 기록 · {name}',
    'stat.지혜': '지혜',
    'stat.공감': '공감',
    'stat.용기': '용기',
    'activity.observatory.label': '별 관측',
    'activity.observatory.hint': '지혜 +3 · 피로 +1',
    'activity.garden.label': '정원 돌보기',
    'activity.garden.hint': '공감 +3 · 피로 +1',
    'activity.workshop.label': '공방 돕기',
    'activity.workshop.hint': '용기 +2 · 은화 +4',
    'activity.rest.label': '달빛 아래 휴식',
    'activity.rest.hint': '피로 -2 · 성장 없음',
    'activity.market.label': '장터 심부름',
    'activity.market.hint': '은화 +6 · 피로 +1',
    ...
    'ui.characterArt.emotions': '기억에 남는 표정',
    'ui.characterArt.day': '이 사람의 하루',
    'ui.characterArt.impression': '첫인상',
    'ui.characterArt.gesture': '자주 하는 모습',
    'ui.characterArt.mood': '지금의 표정',
    'ui.characterArt.back': '← 도감으로 돌아가기',
    'ui.characterArt.footer': '이 표정은 함께한 대화와 기억에 색을 더합니다.',
  });
  en.addAll({
    ...
    'ui.home.goal.free': 'Begin this run without a seasonal goal.',
    'ui.home.goal.complete': 'Every seasonal goal has been recorded.',
    'ui.home.goal.next': 'Next goal · {title} · {stat} {value}/{min}',
    ...
    'ui.home.risk.penalty': 'Fatigue guard · growth -{loss} · rest {days}d',
    'ui.home.risk.strained': 'High fatigue · rest {days}d',
    'ui.home.risk.recovery': 'Recovery · fatigue {delta} · ready in {days}d',
    'ui.home.risk.steady': 'Steady pace',
    'ui.home.save': 'Save / restore',
    'ui.home.illustration': 'Illustration',
    'ui.home.spend': 'Spend the day →',
    'ui.home.chapter':
        'Chapter {chapter} · Lumen week {week}/{total} · {persona}',
    'ui.home.route': 'Route atlas',
    'ui.home.ledger': 'Fate ledger',
    'ui.home.journal': 'Reflection journal',
    'ui.home.characters': 'Character archive',
    'ui.home.environments': 'Environment atlas',
    'ui.environment.summary':
        '6 places · choices, rewards, and memories connect',
    'ui.home.bondsButton': 'Bonds',
    'ui.home.condition.clear': 'A clear mind',
    'ui.home.condition.tired': 'A little tired',
    'ui.home.condition.strained': 'Do not push today',
    'ui.event.small': 'A small event · week {week}',
    'ui.event.choice': 'Choice {index}',
    'ui.event.condition': 'Condition: {value} required',
    'ui.event.statDelta': '{stat} {delta}',
    'ui.event.coinDelta': 'Coins {delta}',
    'ui.event.bondDelta': 'Bond {name} {delta}',
    'ui.event.rivalDelta': 'Relation {name} {delta}',
    'ui.event.statNeeded': '{stat} {min}',
    'ui.event.bondNeeded': 'Bond {name} {min}',
    'ui.event.condition.none': 'No condition',
    'ui.event.locked': 'Locked',
    'ui.home.weeklyRecord': 'weekly record',
    'ui.home.result': 'The record was updated.',
    ...
    'ui.journal.subtitle':
        'Today’s choice does not vanish; it becomes the next way of seeing.',
    'ui.journal.count': 'Found {found}/{total}',
    'ui.journal.hiddenTitle': 'An unwritten page',
    'ui.journal.hidden': 'Keep walking to open this page.',
    'ui.journal.lock': 'A future day will leave a line here.',
    'ui.journal.back': '← Back to home',
    'ui.save.title': 'Save archive',
    'ui.save.subtitle':
        'Keep the current state as a safe code and restore it in another run.',
    'ui.save.replay': 'Records {count} · goals {done}/{total}',
    'ui.save.bonds':
        'Companion bonds · Lumi {lumi} · Bora {bora} · Taro {taro}',
    'ui.save.recent': 'Recent records',
    'ui.save.codeHint':
        'The original save code is handled only through the copy button.',
    'ui.save.endings': 'Ending archive {done}/{total}',
    'ui.save.noEndings': 'No endings discovered yet.',
    'ui.save.routes': 'Relationship archive {done}/{total}',
    'ui.save.noRoutes': 'No companion routes discovered yet.',
    'ui.save.copy': 'Copy save code',
    'ui.save.restore': 'Restore save code',
    'ui.save.back': '← Back to home',
    'ui.save.activity': 'Activity · {stat} {delta}',
    'ui.save.event': 'Event · {label}',
    'ui.save.sideScene': 'Side scene · {title}',
    'ui.save.relationship': 'Relationship record · {name}',
    'stat.지혜': 'Wisdom',
    'stat.공감': 'Empathy',
    'stat.용기': 'Courage',
    'activity.observatory.label': 'Observe the stars',
    'activity.observatory.hint': 'Wisdom +3 · fatigue +1',
    'activity.garden.label': 'Tend the garden',
    'activity.garden.hint': 'Empathy +3 · fatigue +1',
    'activity.workshop.label': 'Help at the workshop',
    'activity.workshop.hint': 'Courage +2 · coins +4',
    'activity.rest.label': 'Rest beneath the moon',
    'activity.rest.hint': 'Fatigue -2 · no growth',
    'activity.market.label': 'Run an errand at the market',
    'activity.market.hint': 'Coins +6 · fatigue +1',
    ...
    'ui.characterArt.focus': 'A familiar gesture',
    'ui.characterArt.emotions': 'Memorable moods',
    'ui.characterArt.day': 'A day in their life',
    'ui.characterArt.impression': 'First impression',
    'ui.characterArt.gesture': 'A familiar gesture',
    'ui.characterArt.mood': 'Current mood',
    'ui.characterArt.back': '← Back to archive',
