...
void main() {
  ...
  for (final path in [
    ...
    'test/goldens/memory-forecast.png',
    'lib/relationship_archive_painter.dart',
    ...
    'lib/activity_forecast.dart',
    'lib/activity_localization.dart',
    'lib/activity_journal_painter.dart',
    'test/activity_forecast_test.dart',
    'test/activity_forecast_golden_test.dart',
    'test/activity_risk_golden_test.dart',
    'test/activity_localization_test.dart',
    'test/activity_reflection_golden_test.dart',
    'test/activity_journal_test.dart',
    'test/activity_journal_golden_test.dart',
    'test/goldens/activity-forecast.png',
    'test/goldens/activity-risk.png',
    'test/goldens/activity-reflection-en.png',
    'test/goldens/activity-journal-en.png',
    'test/goldens/activity-journal-ko.png',
    'lib/legacy_profile_catalog.dart',
    'test/legacy_profile_catalog_test.dart',
    'test/goldens/legacy-picker.png',
    'test/goldens/legacy-picker-en.png',
    'test/goldens/legacy-picker-selected.png',
    ...
    'test/relationship_archive_test.dart',
    ...
    'lib/companion_scene_layout.dart',
    'test/companion_scene_test.dart',
    'test/companion_scene_golden_test.dart',
    'test/goldens/companion-scenes.png',
    'test/goldens/companion-scene-choice.png',
    'test/goldens/companion-scene-recorded.png',
    'test/goldens/companion-scene-recorded-en.png',
    'test/goldens/companion-scene-lumi-mixed.png',
    'test/goldens/companion-scene-bora-mixed.png',
    'test/goldens/companion-scene-taro-mixed.png',
    'test/goldens/companion-scene-locked.png',
    'test/goldens/companion-scene-choice-recall.png',
    'design/tokens.jsonl',
    ...
    'test/design_system_golden_test.dart',
    'test/goldens/design-system-ko.png',
    'test/goldens/design-system-en.png',
    ...
    'test/personality_companion_route_test.dart',
