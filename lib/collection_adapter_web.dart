...
class BrowserCollectionAdapter extends MemoryCollectionAdapter {
  ...
  @override List<Map<String, dynamic>> read() => _decode(web.window.localStorage.getItem(key));
  @override void record(String endingId, int rank) { super.record(endingId, rank); web.window.localStorage.setItem(key, value!); }
