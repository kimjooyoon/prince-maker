...
게임성 KPI는 SSOT의 authored choice를 직접 계산합니다: 94/94 effectful choice, 47/47 divergent event, 94/94 multi-axis choice, 28 gated choice이며, 결과 피드백 Golden과 5-state 관계 resolver/replay trace까지 purity 축의 fail-closed 게이트로 연결됩니다. 상세 계약은 story/story.json의 gameplayKpis·relationshipDesign와 tool/verify_gameplay_fun.dart에 있습니다.
