...
전체 행렬은 [`test/chapter_golden_test.dart`](test/chapter_golden_test.dart)와 [`test/goldens/chapter-*.png`](test/goldens/)에서 확인할 수 있습니다.
