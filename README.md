...
`systemDecisionReceiptGolden`은 [system-receipt.png](test/goldens/system-receipt.png)에서 승인·거절·owner·contract·rule·parent/decision hash를 동시에 고정하고, malformed approval은 fail-closed 테스트로 거절합니다.
