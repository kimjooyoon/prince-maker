...
| 축 | 플레이어에게 의미 | 자동 증거 |
| --- | --- | --- |
| 완전성 | 콘텐츠·분기·저장·화면·대사가 끝까지 이어지는가 | `verify_game.dart` 14차원, 시나리오 8축, 26/26 authored branch, Golden 20종, SSOT 대사 키 × 한국어·English locale 계약, 엔딩 원인 회고 |
