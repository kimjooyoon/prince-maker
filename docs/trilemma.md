...
| 축 | 플레이어에게 의미 | 자동 증거 |
| --- | --- | --- |
| 완전성 | 콘텐츠·분기·저장·화면·대사가 끝까지 이어지는가 | `verify_game.dart` 14차원 + 120분 분량 계약, 시나리오 8축, 100/100 authored branch, Golden 27종(도입·중반·48주 handoff·terminal), 4개 장소 발견 flag/trace, 3개 회차 계승 프로필, 398 locale keys × 한국어·English 계약, 엔딩 원인·미달 목표 회고 |
