...
<!-- source-sha256: 01b636ac1a9e0be05bf9ce4efdc70ee2e77ee0d70f5891a6644f39d0745e5d07|07fe74f96567b0142a4e3c1bff3778a956b314616bf08e3f42399dd3599fd1a2|c1cb1635ab5d433a3afebb90580728603bd36a0c4ae0bcd4266b4bf566389ed8|6b64133de260d3ddf2ae2d21ac597220280091144f0e1a1a18a808867ab2ad77 -->
...
| `G4-presentation` | completeness | P1 | 시각·locale 품질 증적 · `{"goldens":30,"locales":2,"keysPerLocale":1169,"renderPreconditions":3,"renderProofs":4,"unit":"presentation-proof-units"}` | `{"goldens":105,"locales":2,"keysPerLocale":1169,"renderPreconditions":3,"renderProofs":4}` | `{goldens: 0, locales: 0, keysPerLocale: 0, renderPreconditions: 0, renderProofs: 0}` | contract-satisfied; runtime-proof-required |
...
| `G6-accountable-delivery` | performance | P0 | 책임 추적 가능한 납품 · `{"ciChecks":22,"codeRefs":24,"decisionProofFields":14,"unit":"delivery-proof-units"}` | `{"ciChecks":22,"localCiChecks":21,"wasmCiChecks":1,"codeRefs":118,"decisionProofFields":14,"assetRefs":78,"fontRefs":1,"localeRefs":2,"systemAdjudicated":true,"failClosed":true}` | `{ciChecks: 0, codeRefs: 0, decisionProofFields: 0}` | contract-satisfied; runtime-proof-required |
...
| `visual-locale-units` | presentation-unit | **2640** | 105 Goldens + 2 locales × 1169 keys + 118 code refs + 78 asset refs + 1 font refs | visual regression, localization and traceable production assets |
| `verification-units` | proof-unit | **107** | 21 local CI checks + 1 Wasm CI check + 69 Dart test files + 3 render preconditions + 4 render proofs + 14 decision precondition fields | repeatable automated proof and release readiness |
