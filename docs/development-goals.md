...
<!-- source-sha256: ae2943f6df2169d6110e942b7175dfb2817ebd6893f8eb7e2d91e411dac777d9|69d8dbd2ea4904bf18d66681b19db977afd25322c1512fa76a18beeffb84d22f|1ce94c96d1e2f54e039a51d7d63e78a84f26b615ff18ebf5c70c8c63f7ef1bc3|81b962e603c3dc968f395d6e8cfe56f0c85a990f5a62b2cc4032ccaf00f11fcc -->
...
| `G6-accountable-delivery` | performance | P0 | 책임 추적 가능한 납품 · `{"ciChecks":22,"codeRefs":24,"decisionProofFields":14,"unit":"delivery-proof-units"}` | `{"ciChecks":22,"localCiChecks":21,"wasmCiChecks":1,"codeRefs":123,"decisionProofFields":14,"assetRefs":78,"fontRefs":1,"localeRefs":2,"systemAdjudicated":true,"failClosed":true}` | `{ciChecks: 0, codeRefs: 0, decisionProofFields: 0}` | contract-satisfied; runtime-proof-required |
...
| `visual-locale-units` | presentation-unit | **2647** | 105 Goldens + 2 locales × 1170 keys + 123 code refs + 78 asset refs + 1 font refs | visual regression, localization and traceable production assets |
| `verification-units` | proof-unit | **109** | 21 local CI checks + 1 Wasm CI check + 70 Dart test files + 3 render preconditions + 5 render proofs + 14 decision precondition fields | repeatable automated proof and release readiness |
