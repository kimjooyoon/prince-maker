...
<!-- source-sha256: 4b600f8967ae19dbacc00d40fd5e46e47e2ca8e40e370ad2ab5655d8be57e36c|1e51d9268938a0eea54b07d4f9ba37d7c8bff7af7f584cf6bcf5898112a5f4da|74ba654bc5102848bcb4fd6100254f01819e140415f7ae32308aa46254179626|27364b01545072ca3138ab2558cde5ed761511948a327cb8e5a7cf1230e2caef -->
...
| `G4-presentation` | completeness | P1 | 시각·locale 품질 증적 · `{"goldens":30,"locales":2,"keysPerLocale":1048,"renderPreconditions":3,"renderProofs":3,"unit":"presentation-proof-units"}` | `{"goldens":83,"locales":2,"keysPerLocale":1048,"renderPreconditions":3,"renderProofs":3}` | `{goldens: 0, locales: 0, keysPerLocale: 0, renderPreconditions: 0, renderProofs: 0}` | contract-satisfied; runtime-proof-required |
...
| `G6-accountable-delivery` | performance | P0 | 책임 추적 가능한 납품 · `{"ciChecks":19,"codeRefs":24,"decisionProofFields":14,"unit":"delivery-proof-units"}` | `{"ciChecks":19,"localCiChecks":19,"wasmCiChecks":1,"codeRefs":90,"decisionProofFields":14,"assetRefs":78,"fontRefs":1,"localeRefs":2,"systemAdjudicated":true,"failClosed":true}` | `{ciChecks: 0, codeRefs: 0, decisionProofFields: 0}` | contract-satisfied; runtime-proof-required |
...
| `visual-locale-units` | presentation-unit | **2348** | 83 Goldens + 2 locales × 1048 keys + 90 code refs + 78 asset refs + 1 font refs | visual regression, localization and traceable production assets |
...
- 승인 조건: Canvas 좌표·입력 역변환·83개 Golden·ko/en locale 계약이 전부 통과한다.
