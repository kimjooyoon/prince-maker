...
<!-- source-sha256: 10b3e76da5eac0a460bdce2ae88331670383632c665aec15f961e54a04542e68|0742e56652beae88a360f54a269c04dfecb9fe549318c00cbb3c2aa00725f348|74ba654bc5102848bcb4fd6100254f01819e140415f7ae32308aa46254179626|2c469b2f4aaded00281fadcddc89db8013c51da1a4d88eccf6e01e1b34c541a1 -->
...
| `G4-presentation` | completeness | P1 | 시각·locale 품질 증적 · `{"goldens":30,"locales":2,"keysPerLocale":1048,"renderPreconditions":3,"renderProofs":3,"unit":"presentation-proof-units"}` | `{"goldens":81,"locales":2,"keysPerLocale":1048,"renderPreconditions":3,"renderProofs":3}` | `{goldens: 0, locales: 0, keysPerLocale: 0, renderPreconditions: 0, renderProofs: 0}` | contract-satisfied; runtime-proof-required |
...
| `G6-accountable-delivery` | performance | P0 | 책임 추적 가능한 납품 · `{"ciChecks":19,"codeRefs":24,"decisionProofFields":14,"unit":"delivery-proof-units"}` | `{"ciChecks":19,"localCiChecks":19,"wasmCiChecks":1,"codeRefs":89,"decisionProofFields":14,"assetRefs":78,"fontRefs":1,"localeRefs":2,"systemAdjudicated":true,"failClosed":true}` | `{ciChecks: 0, codeRefs: 0, decisionProofFields: 0}` | contract-satisfied; runtime-proof-required |
...
| `visual-locale-units` | presentation-unit | **2345** | 81 Goldens + 2 locales × 1048 keys + 89 code refs + 78 asset refs + 1 font refs | visual regression, localization and traceable production assets |
| `verification-units` | proof-unit | **91** | 19 local CI checks + 1 Wasm CI check + 54 Dart test files + 3 render preconditions + 3 render proofs + 14 decision precondition fields | repeatable automated proof and release readiness |
...
- 승인 조건: Canvas 좌표·입력 역변환·81개 Golden·ko/en locale 계약이 전부 통과한다.
