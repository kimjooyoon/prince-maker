...
<!-- source-sha256: 0f4f5dda7802d6f2d088138b20900d303a08eb255c046365ed0f77d35656b04d|2cab932b37de7425a5029a04014a26ad6b9adb88053672005377a6f539081972|20429dd3129e81a8802ecdd38659f098ac434446c4ca0ad07014fe6e6f6d8a4c|4ec218bb52fb58d11593b7f13c2327dde45f2a4dbddaf293a11beb57d8549942 -->
...
| `G4-presentation` | completeness | P1 | 시각·locale 품질 증적 · `{"goldens":30,"locales":2,"keysPerLocale":1216,"renderPreconditions":3,"renderProofs":5,"unit":"presentation-proof-units"}` | `{"goldens":109,"locales":2,"keysPerLocale":1216,"renderPreconditions":3,"renderProofs":5}` | `{goldens: 0, locales: 0, keysPerLocale: 0, renderPreconditions: 0, renderProofs: 0}` | contract-satisfied; runtime-proof-required |
...
| `G6-accountable-delivery` | performance | P0 | 책임 추적 가능한 납품 · `{"ciChecks":22,"codeRefs":24,"decisionProofFields":14,"unit":"delivery-proof-units"}` | `{"ciChecks":22,"localCiChecks":21,"wasmCiChecks":1,"codeRefs":131,"decisionProofFields":14,"assetRefs":78,"fontRefs":1,"localeRefs":2,"systemAdjudicated":true,"failClosed":true}` | `{ciChecks: 0, codeRefs: 0, decisionProofFields: 0}` | contract-satisfied; runtime-proof-required |
...
| `visual-locale-units` | presentation-unit | **2751** | 109 Goldens + 2 locales × 1216 keys + 131 code refs + 78 asset refs + 1 font refs | visual regression, localization and traceable production assets |
| `verification-units` | proof-unit | **114** | 21 local CI checks + 1 Wasm CI check + 75 Dart test files + 3 render preconditions + 5 render proofs + 14 decision precondition fields | repeatable automated proof and release readiness |
...
- 승인 조건: Canvas 좌표·입력 역변환·109개 Golden·ko/en locale 계약이 전부 통과한다.
