...
<!-- source-sha256: a1e2751da583a6460471c4677522258c2e15a6414c35216f586eba1ec447f8d5|b0c56bee0a1fa15cdb7c0e3b69e7719b8b2834099d90f82bda0729308a5bbf1e|74ba654bc5102848bcb4fd6100254f01819e140415f7ae32308aa46254179626|4ed4303f058127bff03f8c558ef2294aba110d94c87b26f69f59d78a29200a90 -->
...
| `G4-presentation` | completeness | P1 | 시각·locale 품질 증적 · `{"goldens":30,"locales":2,"keysPerLocale":1051,"renderPreconditions":3,"renderProofs":3,"unit":"presentation-proof-units"}` | `{"goldens":87,"locales":2,"keysPerLocale":1051,"renderPreconditions":3,"renderProofs":3}` | `{goldens: 0, locales: 0, keysPerLocale: 0, renderPreconditions: 0, renderProofs: 0}` | contract-satisfied; runtime-proof-required |
...
| `G6-accountable-delivery` | performance | P0 | 책임 추적 가능한 납품 · `{"ciChecks":22,"codeRefs":24,"decisionProofFields":14,"unit":"delivery-proof-units"}` | `{"ciChecks":22,"localCiChecks":21,"wasmCiChecks":1,"codeRefs":95,"decisionProofFields":14,"assetRefs":78,"fontRefs":1,"localeRefs":2,"systemAdjudicated":true,"failClosed":true}` | `{ciChecks: 0, codeRefs: 0, decisionProofFields: 0}` | contract-satisfied; runtime-proof-required |
...
| `visual-locale-units` | presentation-unit | **2363** | 87 Goldens + 2 locales × 1051 keys + 95 code refs + 78 asset refs + 1 font refs | visual regression, localization and traceable production assets |
| `verification-units` | proof-unit | **93** | 21 local CI checks + 1 Wasm CI check + 56 Dart test files + 3 render preconditions + 3 render proofs + 14 decision precondition fields | repeatable automated proof and release readiness |
...
- 승인 조건: Canvas 좌표·입력 역변환·87개 Golden·ko/en locale 계약이 전부 통과한다.
