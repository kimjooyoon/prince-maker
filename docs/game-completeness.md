...
| 시각 회귀 | 한국어 fixture 8개·English locale 3개·사건 피드백·관계 긴장·관계 중재·외출·유대 게이트·기억 게이트·계승 게이트·계승 프로필 보정 피드백·나비효과/동료 퀘스트 기록 보관소(ko/en)·시스템 승인/거절 영수증 + canonical SSOT 홈·4주차 사건·48주 handoff 사건·엔딩·원인 회고·엔딩 도감·16막 canonical 사건·실제 16막 chapter-closure 관계 장면 Canvas Golden | 62 |
...
| locale 계약 | SSOT `*Key` 전수 존재·비공백·ko/en 각 488키 이상 및 character speaker·엔딩·운명 기록·chapter relationship scene UI 키 검사 | 1 |
