...
| 관계 | 동료 3명, 인사→유대→에필로그 | 3 companion, threshold, epilogue | 관계 충돌/소원함/상호 배타 선택 추가 |
...
| 장면 | 도입·중반 사건·엔딩 Golden | 15 Golden, canonical 4주차 사건 | 막별 canonical event Golden 4종으로 확장 |
