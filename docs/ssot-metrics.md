...
| 1회차 추정 | 137분 | `contentBudget.estimatedFirstPlaythroughMinutes` |
...
| locale 최소 키 | 494 | `dialogueMetrics.minimumLocaleKeys` |
| 캠페인 최소 대사 줄 | 63 | 48주 authored 사건 선택 노출 기준 |
| 캠페인 최소 서사 단위 | 176 | 성격·사건 제목/본문·선택·엔딩 |
