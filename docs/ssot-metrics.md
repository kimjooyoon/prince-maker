...
<!-- ssot-sha256: 38ff99bd7cbd86ae90dc5529461bc1e7a111d491501e4a8f1ab3ac174c18260e -->
...
| 엔딩 | 6 | `endings.length` |
| Canvas Golden | 103 | `test/goldens/*.png` |
| 코드 ref | 108 | `codeRefs.length` |
...
| locale 최소 키 | 1160 | `dialogueMetrics.minimumLocaleKeys` |
