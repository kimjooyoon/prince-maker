...
Map<String, dynamic> play(StoryPort story, Map<String, dynamic> activity) {
  ...
  while (session.world.progress[0]!.week < story.endingWeek) {
    ...
    final choice = choices.firstWhere((choice) => (choice['requiresStat'] == null || (session.world.stats[0]!.values[choice['requiresStat']] ?? 0) >= (choice['requiresMin'] as int? ?? 0)) && (choice['requiresBondId'] == null || (session.world.progress[0]!.bonds[choice['requiresBondId']] ?? 0) >= (choice['requiresBondMin'] as int? ?? 0)));
